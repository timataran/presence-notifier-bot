...
class TestNotifierStarter(TestCase):
    ...
    def test_pass_dispatcher_to_components_on_start(self, sender, receiver, connection_monitor, dispatcher):
    ...
    @patch('notifier.Receiver')
    @patch('notifier.Sender')
    def test_invoke_connection_monitor_start(self, sender, receiver, connection_monitor, dispatcher):
        monitor = Mock()
    ...
    @patch('notifier.Receiver')
    @patch('notifier.Sender')
    def test_invoke_receiver_start(self, sender, receiver, connection_monitor, dispatcher):
        bot_receiver = Mock()
